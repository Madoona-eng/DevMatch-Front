  ...
  return (
    <div className="flex justify-center items-center space-x-2">
      <button
        ...
        className="px-4 py-2 rounded-lg bg-white text-blue-600 border border-blue-200 hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm"
      >
        Previous
      </button>
      {pages.map(page => (
